...
func (ec *executionContext) field_Mutation_createDog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewDog2ᚖgraphqlᚑtutoᚋgraphᚋmodelᚐNewDog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createDog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateDog(rctx, fc.Args["input"].(*model.NewDog))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgraphqlᚑtutoᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Mutation_createDog(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "_id":
				return ec.fieldContext_Dog__id(ctx, field)
			case "name":
				return ec.fieldContext_Dog_name(ctx, field)
			case "isGoodBoi":
				return ec.fieldContext_Dog_isGoodBoi(ctx, field)
			}
...
func (ec *executionContext) _Query_dog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Dog(rctx, fc.Args["_id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_dogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Dog)
	fc.Result = res
	return ec.marshalNDog2ᚕᚖgraphqlᚑtutoᚋgraphᚋmodelᚐDogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDog2graphqlᚑtutoᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖgraphqlᚑtutoᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖgraphqlᚑtutoᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖgraphqlᚑtutoᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalONewDog2ᚖgraphqlᚑtutoᚋgraphᚋmodelᚐNewDog(ctx context.Context, v interface{}) (*model.NewDog, error) {
	if v == nil {
		return nil, nil
	}
